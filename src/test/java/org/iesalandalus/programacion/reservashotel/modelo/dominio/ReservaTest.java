...
public class ReservaTest {
    ...
    Habitacion habitacionSimple = new Simple(PLANTA_1, PUERTA_10, PRECIO_HABITACION_SIMPLE);
    ...
    void toStringDevuelveLaCadenaEsperada() {
        ...
        String cadenaEsperada=String.format("Huesped: %s %s Habitación:%s Fecha Inicio Reserva: %s Fecha Fin Reserva: %s Checkin: %s Checkout: %s Precio: %.2f Personas: %d",
        ...
        cadenaEsperada=String.format("Huesped: %s %s Habitación:%s Fecha Inicio Reserva: %s Fecha Fin Reserva: %s Checkin: %s Checkout: %s Precio: %.2f Personas: %d", reserva.getHuesped().getNombre(), reserva.getHuesped().getDni(),
                reserva.getHabitacion(), reserva.getFechaInicioReserva().format(formatoFecha),
